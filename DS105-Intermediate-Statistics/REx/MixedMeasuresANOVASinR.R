...
# Did those who ate breakfast in the morning improve their resting metabolic rate from baseline to follow up compared to 
# those who skipped breakfast?  
# In order to answer this question, your first x, or independent variable, will be the Treatment.Group of whether they ate 
# breakfast in the morning or not. Your second x will be time, whether it was baseline or follow up. Your y, or dependent variable, 
# will be resting metabolic rate. As with all ANOVAs, the IV will be categorical, and the DV will be continuous.
...
# 
# The first row is the treatment group (skipping breakfast or eating breakfast) and looks at changes in resting metabolic 
# rate by treatment group, regardless of the time point. It's basically a one-way ANOVA.
# 
# Same thing with the second row! But instead of treatment group, you have time as your one-way factor. This row is just 
# looking at change in resting metabolic rate from time point one to time point 2, regardless of what treatment group 
...
# This line is called the interaction effect. It looks at change in the resting metabolic rate over time by treatment group.
# 

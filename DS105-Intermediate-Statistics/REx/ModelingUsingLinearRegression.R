...
# If you had not transformed your dependent variable, you can add one more interpretation
# to your R output. Here is the model without any data transformations:
...
#Predictions
# If you want to predict the number of manatees that will be killed if, say,
# 850 thousand powerboats are registered, then you plug x = 850 into the equation, and determine the predicted value:
  
#  y = 0.129(850) −42.542 y = 67.1

# Note that if there are 850 thousand powerboats registered, then the regression equation suggests that
# there will be an estimated 67.1 manatees killed. Of course, you cannot kill a fraction of a manatee.
# However, when making predictions, it is appropriate to leave the prediction as a decimal. 
# This is a predicted value, so it does not actually have to be attainable.
